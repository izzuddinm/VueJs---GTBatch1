<template>
      ...
      <div
        ...
        style="width: 90px"
      >
        <img src="../assets/img/side-1.png" alt="" />
        <img src="../assets/img/side-2.png" alt="" />
        <img src="../assets/img/side-3.png" alt="" />
        <img src="../assets/img/side-1.png" alt="" />
        <img src="../assets/img/side-2.png" alt="" />
      </div>
      <div class="kursi">
        <img id="chair-id" :src="require('../assets/img/'+ imgTampungProp + '.png')"  alt="kursi" width="95%" />
      </div>

      <div class="text">
        <h2>Chair Thatty</h2>
        <p>IDR 12.000.000</p>
       <router-link to="/shipping" class="btn text-dark" style="background-color: pink;"><img src="../assets/img/cart-icon.png" alt=""> add to chart</router-link>
        <br />
